...
class QualityGateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] is_default: Name of the quality gate to set as default
        """
...
class QualityGate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a QualityGate resource with the given unique name, props, and options.
